...
type Snack struct {
	ID 			       int 		 `json:"" gorm:"column:snack_id;primaryKey;autoIncrement"`
	SnackTypeID    int      `json:"" gorm:"column:snack_type_id;not null"`
	...
	OrderThreshold int 		 `gorm:"column:order_threshold"`
